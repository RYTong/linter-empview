                    ...
                    try {
                        ...
                        if (aSplitRe.length & 1) {
                            ...
                            do {
                                ...
                                if ((iStartIndex && !iEndIndex) || (!iStartIndex && iEndIndex)) {
                                    // 未闭合
                                    // 返回缺失位置
                                ...
                                if (iStartIndex > iEndIndex) {
                                    ...
                                    let iLine = get_error_position(editorText, iEndIndex);

                                    aErrArr.push(new_slt_linter_msg(editor.getPath(), iLine, iEndIndex, "unclose start tag!"));
                                    break;
                                    ...
                                    let iLine = get_error_position(editorText, iPreStartIndex);
                                    aErrArr.push(new_slt_linter_msg(editor.getPath(), iLine, iPreStartIndex, "unclose end tag!"));
                                    break;
                                }
