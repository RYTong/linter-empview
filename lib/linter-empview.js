                        ...
                        if (aErrArr.length) {
                            ...
                            for (let i = 0; i < aSplitRe.length; i++) {
                              if (i & 1) {
                                ...
                                sStr = sStr.replace(/[\s\r\n]*/ig, "");
                                // console.log(" do slt : ", sStr);
                                if (bFlag) {

                                  if ((sStr.match(/^if/i) && sStr.match(/then$/i)) ) {
                                    iLevel += 1;
                                  } else if ((sStr.match(/end/i) && sStr.length < 5) || (sStr.match(/end[;]*$/i)) ) {
                                  ...
                                  if ((sStr.match(/^else/i) && sStr.length < 6) || (sStr.match(/^elseif/i) && sStr.match(/then$/i)) ) {
                                    // console.log("---- do level +1");
                                    bFlag  = true;
                                  }
                                }
                                ...
                                // console.log("do html");
                                if (bFlag) {
                                  // console.log(aSplitRe[i]);
                                  // console.log("---- do html level concat");
                                  let aRe = aSplitRe[i].match(/\n/ig);
                                  ...
                                  // console.log("---- do html unlevel concat");
